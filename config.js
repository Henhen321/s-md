...
global.DATABASE_URL = process.env.DATABASE_URL || "7iyQsXiDSWL3Wjfn7JQ@bpvwwpn4owh5hpxbv9sp-mysql.services.clever-cloud.com"
...
global.devs = "6285866034212" // Developer Contact
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "null";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "6285866034212";
...
module.exports = {
  ...
  caption : global.caption || "C-Arv MD" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ c-Arv-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
 
  author : process.env.PACK_AUTHER|| "",
  packname: process.env.PACK_NAME || "",
  botname : process.env.BOT_NAME  || "C-Arv-ᴍᴅ",
  ownername:process.env.OWNER_NAME|| "It'x Henz",
  ...
  OPENAI_API_KEY: process.env.OPENAI_API_KEY || "sk-proj-CJAt9YIMnJOiYhU6ziTvT3BlbkFJbOxUIdECJWyt1OAEw6po",
